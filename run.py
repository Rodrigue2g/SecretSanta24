...
"""
 {"name": "Rémi", "image": "remi.png", "nbr": 4, "mail": "remi.desire@epfl.ch"},
    {"name": "Spout", "image": "spout.png", "nbr": 3, "mail": "guillaume.hugo@epfl.ch"},
    {"name": "Alexis", "image": "alexis.png", "nbr": 2, "mail": "alexis.firome@epfl.ch"},
    {"name": "Emma", "image": "emma.png", "nbr": 3, "mail": "emma.brenenholt@epfl.ch"},
    ...
    {"name": "Georges", "image": "georges.png", "nbr": 2, "mail": "georges.moussallie@epfl.ch"},
    ...
    {"name": "Baptou", "image": "baptou.png", "nbr": 1, "mail": "baptiste.chatilabruntotte@epfl.ch"},
...
def tirageSS():
    try:
        ...
        assigned_people = people[:]  # Create a copy of the list
        while True:
            random.shuffle(assigned_people)  # Shuffle the list to ensure randomness
            if all(person["name"] != assigned["name"] for person, assigned in zip(people, assigned_people)):
                break  # Exit the loop if no one is assigned to themselves
        ...
        #rint("Assignments have been saved to 'assignments.json'.")
